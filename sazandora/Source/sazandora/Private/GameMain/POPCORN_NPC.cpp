...
#include "../Public/GameMain/POPCORN_NPC.h"
...
APOPCORN_NPC::APOPCORN_NPC()
{
	...
	// meshをセット
	static ConstructorHelpers::FObjectFinder<USkeletalMesh> MeshObj(TEXT("/Game/PolygonCity/Meshes/Characters/SK_Character_Female_Jacket"));
